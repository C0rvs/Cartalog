...
public class ToyCatalogServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       else if(valueString.equals("books")) {
           if (books.isEmpty()) {
       ...
       else if(valueString.equals("flowers")) {
           if (flowers.isEmpty()) {
               stringBuilder.append("<b>Flowers Catalog Empty</b>");
           } 
           else {
               stringBuilder.append("<table class='table'>");
               stringBuilder.append("<thead>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String catalogString = request.getParameter("catalogs");

        
        if(catalogString.equals("toys")) {
        ...
        else if(catalogString.equals("books")) {
        ...
        else if(catalogString.equals("flowers")) {
