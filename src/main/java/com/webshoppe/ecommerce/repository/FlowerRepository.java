...
public class FlowerRepository {
    private final static String FLOWERS_FIND_ALL = "SELECT fid, fname, fdesc, fprice FROM flowersdetails";
    private final static String FLOWERS_FIND_BY_PRICE = FLOWERS_FIND_ALL + " WHERE fprice BETWEEN ? AND ?";
    ...
    public List<Flower> findAll() {
        try {
            ...
            final PreparedStatement findAllQuery = connection.prepareStatement(FLOWERS_FIND_ALL);
    ...
    public List<Flower> findByPrice(BigDecimal minimumPrice, BigDecimal maximumPrice) {
        try {
            ...
            final PreparedStatement findAllQuery = connection.prepareStatement(FLOWERS_FIND_BY_PRICE);
