...
public class BookRepository {
    private final static String BOOKS_FIND_ALL = "SELECT bid, title, bookdesc, bookprice FROM booksdetails";
    private final static String BOOKS_FIND_BY_PRICE = BOOKS_FIND_ALL + " WHERE bookprice BETWEEN ? AND ?";
    ...
    public List<Book> findAll() {
        try {
            ...
            final PreparedStatement findAllQuery = connection.prepareStatement(BOOKS_FIND_ALL);
    ...
    public List<Book> findByPrice(BigDecimal minimumPrice, BigDecimal maximumPrice) {
        try {
            ...
            final PreparedStatement findAllQuery = connection.prepareStatement(BOOKS_FIND_BY_PRICE);
